...
def send_email_internal(to_addr: str, subject: str, body: str) -> str:
    ...
    smtp_server = "mail.gmail.com"  # This might need to be updated
...
My name is Jeff Huang. You are my email assistant, Monica. You have access to the following tools:
